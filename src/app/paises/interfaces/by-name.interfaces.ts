export interface SearchByNameCountry {
    name:           string;
...
export class Convert {
    public static toSearchGIFResponse(json: string): SearchByNameCountry[] {
        return cast(JSON.parse(json), a(r("SearchGIFResponse")));
    }

    public static searchGIFResponseToJson(value: SearchByNameCountry[]): string {
        return JSON.stringify(uncast(value, a(r("SearchGIFResponse"))), null, 2);
    }
}
